...
// Testando a função
console.log(saudacao(null, false , false)); // Esperado: "Olá, Visitante!"
console.log(saudacao(undefined, false , false)); // Esperado: "Olá, Visitante!"
console.log(saudacao("", false , false)); // Esperado: "Olá, !"
